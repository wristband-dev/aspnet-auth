...
public class LoginConfig
{
    ...
    /// <param name="defaultTenantName">An optional default tenant name to use for the login request.</param>
    ...
    /// <summary>
    /// Gets or sets the optional default tenant name to use for the login request.
    /// </summary>
